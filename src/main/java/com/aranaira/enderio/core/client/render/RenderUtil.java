...
import com.aranaira.enderio.core.client.handlers.ClientHandler;
import com.aranaira.enderio.core.common.util.NNList;
import com.aranaira.enderio.core.common.util.NNList.Callback;
import com.aranaira.enderio.core.common.vecmath.Vector3d;
import com.aranaira.enderio.core.common.vecmath.*;
...
public class RenderUtil {
	...
	public static final @Nonnull
	Vector4f DEFAULT_TEXT_BG_COL = new Vector4f(0.275f, 0.08f, 0.4f, 0.75f);

	public static final @Nonnull
	com.aranaira.enderio.core.common.vecmath.Vector3d UP_V = new com.aranaira.enderio.core.common.vecmath.Vector3d(0, 1, 0);

	public static final @Nonnull
	com.aranaira.enderio.core.common.vecmath.Vector3d ZERO_V = new com.aranaira.enderio.core.common.vecmath.Vector3d(0, 0, 0);

	private static final @Nonnull
	FloatBuffer MATRIX_BUFFER = GLAllocation.createDirectFloatBuffer(16);

	public static final @Nonnull
	ResourceLocation BLOCK_TEX = TextureMap.LOCATION_BLOCKS_TEXTURE;

	public static final @Nonnull
	ResourceLocation GLINT_TEX = new ResourceLocation("textures/misc/enchanted_item_glint.png");
	...
	public static @Nonnull
	float[] getDefaultPerSideBrightness () {
	...
	public static Matrix4d createBillboardMatrix (@Nonnull TileEntity te, @Nonnull EntityLivingBase entityPlayer) {
		...
		return createBillboardMatrix(new com.aranaira.enderio.core.common.vecmath.Vector3d(p.getX() + 0.5, p.getY() + 0.5, p.getZ() + 0.5), entityPlayer);
	}

	public static Matrix4d createBillboardMatrix (@Nonnull com.aranaira.enderio.core.common.vecmath.Vector3d lookAt, @Nonnull EntityLivingBase entityPlayer) {
		com.aranaira.enderio.core.common.vecmath.Vector3d playerEye = new com.aranaira.enderio.core.common.vecmath.Vector3d(entityPlayer.posX, entityPlayer.posY + 1.62 - entityPlayer.getYOffset(), entityPlayer.posZ);
		com.aranaira.enderio.core.common.vecmath.Vector3d blockOrigin = new com.aranaira.enderio.core.common.vecmath.Vector3d(lookAt.x, lookAt.y, lookAt.z);
		Matrix4d lookMat = VecmathUtil.createMatrixAsLookAt(blockOrigin, playerEye, RenderUtil.UP_V);
		lookMat.setTranslation(new com.aranaira.enderio.core.common.vecmath.Vector3d());
		lookMat.invert();
		return lookMat;
	}
	...
	public static void renderBillboard (@Nonnull Matrix4d lookMat, float minU, float maxU, float minV, float maxV, double size, int brightness) {
		...
		double s = size / 2;
		com.aranaira.enderio.core.common.vecmath.Vector3d v = new com.aranaira.enderio.core.common.vecmath.Vector3d();
		v.set(-s, s, 0);
		lookMat.transform(v);
	...
	public static void getUvForCorner (
			@Nonnull Vector2f uv, @Nonnull com.aranaira.enderio.core.common.vecmath.Vector3d corner, int x, int y, int z, @Nonnull EnumFacing face, @Nonnull TextureAtlasSprite icon) {
		com.aranaira.enderio.core.common.vecmath.Vector3d p = new Vector3d(corner);
		p.x -= x;
		p.y -= y;
		p.z -= z;
	...
	public static @Nonnull
	Vector4d getVPlaneForFace (@Nonnull EnumFacing face) {
		switch (face) {
			case DOWN:
			case UP:
	...
	public static @Nonnull
	Vector4d getUPlaneForFace (@Nonnull EnumFacing face) {
		switch (face) {
			case EAST:
	...
	public static @Nonnull
	EnumFacing getVDirForFace (@Nonnull EnumFacing face) {
		switch (face) {
			case DOWN:
			case UP:
				return SOUTH;
	...
	public static @Nonnull
	EnumFacing getUDirForFace (@Nonnull EnumFacing face) {
		switch (face) {
			case EAST:
				return NORTH;
			case WEST:
	...
	public static @Nonnull
	TextureAtlasSprite getStillTexture (@Nonnull FluidStack fluidstack) {
	...
	public static @Nonnull
	TextureAtlasSprite getStillTexture (@Nonnull Fluid fluid) {
	...
	public static void drawBillboardedText (
			@Nonnull Vector3f pos, @Nonnull String text, float size, @Nonnull Vector4f txtCol, boolean drawShadow, @Nullable Vector4f shadowCol, boolean drawBackground, @Nullable Vector4f bgCol) {
	...
	public static @Nonnull
	TextureAtlasSprite getTexture (@Nonnull IBlockState state) {
	...
	public static void addBakedQuads (
			@Nonnull final List<BakedQuad> quads, @Nonnull final BoundingBox bb, @Nonnull final TextureAtlasSprite tex, final Vector4f color) {
		addBakedQuads(quads, bb, FULL_UVS, tex, color);
	}

	public static void addBakedQuads (
			@Nonnull final List<BakedQuad> quads, @Nonnull final BoundingBox bb, @Nonnull Vector4f uvs, @Nonnull final TextureAtlasSprite tex, final Vector4f color) {
		NNList.FACING.apply(new Callback<EnumFacing>() {
			@Override
	...
	public static void addBakedQuadForFace (
			@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb, @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing face, @Nonnull Vector4f uvs) {
		addBakedQuadForFace(quads, bb, tex, face, uvs, false, false);
	}

	public static void addBakedQuadForFace (
			@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb, @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing face, boolean rotateUV, boolean flipU) {
		addBakedQuadForFace(quads, bb, tex, face, FULL_UVS, rotateUV, flipU);
	}

	public static void addBakedQuadForFace (
			@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb, @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing face, @Nonnull Vector4f uvs, boolean rotateUV, boolean flipU) {
		addBakedQuadForFace(quads, bb, tex, face, null, rotateUV, flipU, true, null);
	}

	public static void addBakedQuadForFace (
			@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb, @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing face, @Nullable VertexTransform xform, boolean rotateUV, boolean flipU, boolean recolor, @Nullable Vector4f color) {
		addBakedQuadForFace(quads, bb, tex, face, FULL_UVS, null, rotateUV, flipU, recolor, color);
	}

	public static void addBakedQuadForFace (
			@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb, @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing face, @Nonnull Vector4f uvs, @Nullable VertexTransform xform, boolean rotateUV, boolean flipU, boolean recolor, @Nullable Vector4f color) {
		Builder builder = new Builder(DefaultVertexFormats.ITEM);
	...
	public static void addBakedQuads (
			@Nonnull List<BakedQuad> quads, @Nonnull Collection<Vertex> vertices, @Nonnull TextureAtlasSprite tex, @Nullable Vector4f color) {
		Iterator<Vertex> it = vertices.iterator();
		while (it.hasNext()) {
			EnumFacing face = EnumFacing.DOWN;
			Builder builder = new Builder(Attributes.DEFAULT_BAKED_FORMAT);
			for (int i = 0; i < 4; i++) {
				Vertex v = it.next();
				if (i == 0) {
