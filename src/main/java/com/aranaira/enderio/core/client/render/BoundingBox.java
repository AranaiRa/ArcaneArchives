...
public final class BoundingBox extends AxisAlignedBB {
  ...
  BoundingBox UNIT_CUBE = new BoundingBox(0, 0, 0, 1, 1, 1);
  ...
  public @Nonnull
  BoundingBox expandBy(@Nonnull BoundingBox other) {
    return new BoundingBox(Math.min(minX, other.minX), Math.min(minY, other.minY), Math.min(minZ, other.minZ), Math.max(maxX, other.maxX), Math.max(maxY, other.maxY), Math.max(maxZ, other.maxZ));
  }
  ...
  public @Nonnull
  BoundingBox scale(float xyz) {
    return scale((double) xyz, (double) xyz, (double) xyz);
  }

  public @Nonnull
  BoundingBox scale(double xyz) {
    return scale(xyz, xyz, xyz);
  }

  public @Nonnull
  BoundingBox scale(float x, float y, float z) {
    return scale((double) x, (double) y, (double) z);
  }

  public @Nonnull
  BoundingBox scale(double x, double y, double z) {
   ...
   */
  public @Nonnull
  List<Vertex> getCornersWithUvForFace(@Nonnull EnumFacing face) {
   ...
   */
  public @Nonnull
  NNList<Vertex> getCornersWithUvForFace(@Nonnull EnumFacing face, float minU, float maxU, float minV, float maxV) {
   ...
   */
  public @Nonnull
  List<Vector3f> getCornersForFace(@Nonnull EnumFacing face) {
   ...
   */
  public @Nonnull
  List<Vector3d> getCornersForFaceD(@Nonnull EnumFacing face) {
  ...
  public @Nonnull
  BoundingBox transform(@Nonnull VertexTransform vertexTransform) {
