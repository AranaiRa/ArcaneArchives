...
public class NNList<E> extends NonNullList<E> {
	...
	NNList<EnumFacing> FACING = NNList.of(EnumFacing.class);

	public static final @Nonnull
	NNList<EnumFacing> FACING_HORIZONTAL = new NNList<EnumFacing>(EnumFacing.HORIZONTALS);

	public static final @Nonnull
	NNList<BlockRenderLayer> RENDER_LAYER = NNList.of(BlockRenderLayer.class);

	public static final @Nonnull
	NNList<BlockPos> SHELL = new NNList<>();
	...
	public static @Nonnull
	<T> Collector<T, ?, NNList<T>> collector () {
	 ...
	 *
	 * @throws InvalidParameterException if the given element is not part of the list.
	 */
	public @Nonnull
	E next (E current) {
	...
	NNList<Object> EMPTY = new NNList<Object>(Collections.emptyList(), null);

	@SuppressWarnings("unchecked")
	public static @Nonnull
	<X> NNList<X> emptyList () {
