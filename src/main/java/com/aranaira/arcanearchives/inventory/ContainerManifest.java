...
public class ContainerManifest extends Container implements IScrollableContainer {
  ...
  public ContainerManifest(PlayerEntity playerIn) {
  ...
  /**
   * Ensure this container has at least this many {@link Slot}s
   *
  ...
  public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, PlayerEntity player) {
    ...
    if ((ConfigHandler.ManifestConfig.holdShift && !Screen.isShiftKeyDown() && dragType == 0) || (!ConfigHandler.ManifestConfig.holdShift && Screen.isShiftKeyDown() && dragType == 0)) {
