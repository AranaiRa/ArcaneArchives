...
public class ServerNetwork implements IServerNetwork {
  ...
  public boolean anyLoaded() {
    ...
    for (Entry<Set<ChunkPos>> entry : map.int2ObjectEntrySet()) {
      ...
      ServerWorld dimWorld = DimensionManager.getWorld(dimension);
      ServerChunkProvider provider = dimWorld.getChunkProvider();
   ...
   */
  public static ServerNetwork fromNBT(CompoundNBT data) {
  ...
  @Override
  public CompoundNBT writeToSave() {
  ...
  @Override
  public void readFromSave(CompoundNBT tag) {
