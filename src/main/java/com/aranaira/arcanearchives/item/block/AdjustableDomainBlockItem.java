...
public class AdjustableDomainBlockItem extends AbstractDomainBlockItem {
  public AdjustableDomainBlockItem(Block pBlock, Properties pProperties) {
  ...
  public void appendHoverText(ItemStack pStack, @Nullable World pLevel, List<ITextComponent> pTooltip, ITooltipFlag pFlag) {
    ...
    pTooltip.add(new TranslationTextComponent("arcanearchives.tooltip.domain_item.howto", new TranslationTextComponent("arcanearchives.tooltip.domain_item.sneak").setStyle(Style.EMPTY.withBold(true).withColor(TextFormatting.GRAY))).setStyle(Style.EMPTY.withColor(TextFormatting.DARK_GRAY)));
  }
}
