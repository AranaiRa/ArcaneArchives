...
@Mod(modid = ArcaneArchives.MODID, name = ArcaneArchives.NAME, version = ArcaneArchives.VERSION, dependencies = "required-after:gbook_snapshot;required-after:baubles;required-before:mysticallib;after:thaumcraft")
public class ArcaneArchives {
	...
	public static final String VERSION = "0.2.0-preview16-hotfix2";
