...
public class PlayerNetworkConfig implements ISerializePacketBuffer<PlayerNetworkConfig> {
  ...
  public static PlayerNetworkConfig fromClient() {
    ...
    return new PlayerNetworkConfig(player.getUniqueID(), 100, false, false); //ManifestConfig.MaxDistance, ConfigHandler.defaultRoutingNoNewItems, ConfigHandler.trovesDispense);
  }
