...
public class ItemRegistry {
	...
	public static void onModelRegister (ModelRegistryEvent event) {
		Arrays.asList(RAW_RADIANT_QUARTZ, SHAPED_RADIANT_QUARTZ, EMPOWERED_RADIANT_QUARTZ, DEBUG_ORB, /*GEOMANCY_PENDULUM, GEOMANTIC_MAP,*/ MANIFEST, /*RADIANT_AMPHORA, SCEPTER_ABDUCTION, SCEPTER_MANIPULATION, SCEPTER_TRANSLOCATION*/ LETTER_OF_INVITATION, LETTER_OF_RESIGNATION, WRIT_OF_EXPULSION, /*TOME_OF_REQUISITION,*/ RADIANT_AMPHORA, COMPONENT_CONTAINMENTFIELD, COMPONENT_MATRIXBRACE, COMPONENT_MATERIALINTERFACE, COMPONENT_RADIANTDUST, COMPONENT_SCINTILLATINGINLAY, DEVOURING_CHARM, SERENITY_CHARM/*, SPIRIT_ORB*/, SCEPTER_REVELATION, SCEPTER_MANIPULATION, ECHO, BAUBLE_GEMSOCKET, /*FABRIAL*/ SLAUGHTERGLEAM, MURDERGLEAM, AGEGLEAM, CLEANSEGLEAM, SWITCHGLEAM, SALVEGLEAM, MUNCHSTONE, /*TRANSFERSTONE,*/ ORDERSTONE, MINDSPINDLE, ELIXIRSPINDLE, MOUNTAINTEAR, RIVERTEAR, PARCHTEAR, PHOENIXWAY, STORMWAY, CHROMATIC_POWDER, RAINBOW_CHROMATIC_POWDER).forEach(ItemTemplate::registerModels);
