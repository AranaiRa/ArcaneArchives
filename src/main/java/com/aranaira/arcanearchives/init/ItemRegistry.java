...
public class ItemRegistry {
	...
	public static List<Item> ARSENAL_ITEMS = Arrays.asList(/*FABRIAL, */MURDERGLEAM, CLEANSEGLEAM, /*SWITCHGLEAM,*/ SALVEGLEAM, MUNCHSTONE, /*TRANSFERSTONE,*/ ORDERSTONE, MINDSPINDLE, ELIXIRSPINDLE, MOUNTAINTEAR, RIVERTEAR, PARCHTEAR, PHOENIXWAY, STORMWAY);
	//BAUBLES
