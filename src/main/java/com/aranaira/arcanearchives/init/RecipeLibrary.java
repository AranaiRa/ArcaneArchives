...
public class RecipeLibrary 
{
	...
	public static GemCuttersTableRecipe COMPONENT_RADIANTDUST_RECIPE = new GemCuttersTableRecipe(Arrays.asList(new ItemStack(ItemLibrary.RAW_RADIANT_QUARTZ, 1)), new ItemStack(ItemLibrary.COMPONENT_RADIANTDUST, 1));
