...
import com.aranaira.arcanearchives.IRegistryLocation;
...
public abstract class Processor<H extends IArcaneInventory, C extends Container & IPlayerContainer, T extends TileEntity & IArcaneArchivesTile> implements IProcessor<H, C, T>, IResourceLocation, IRegistryLocation {
  protected ResourceLocation resourceLocation;
  protected ResourceLocation registryLocation;

  public Processor(ResourceLocation registry, ResourceLocation resourceLocation) {
