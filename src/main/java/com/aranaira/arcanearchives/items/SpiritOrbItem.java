...
public class SpiritOrbItem extends ItemMultistateTemplate
{
	...
	public static ItemStack 
		EMPTY,
		CROWN_MOTE,  CROWN_JUVE,  CROWN_ELD,
		MATTER_MOTE, MATTER_JUVE, MATTER_ELD,
		POWER_MOTE,  POWER_JUVE,  POWER_ELD,
		SPACE_MOTE,  SPACE_JUVE,  SPACE_ELD,
		TIME_MOTE,   TIME_JUVE,   TIME_ELD;
