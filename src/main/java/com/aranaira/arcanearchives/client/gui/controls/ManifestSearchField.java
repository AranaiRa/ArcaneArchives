...
public class ManifestSearchField extends RightClickTextField {
  private int id;
  private ManifestGUI gui;

  public ManifestSearchField(ManifestGUI gui, int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
