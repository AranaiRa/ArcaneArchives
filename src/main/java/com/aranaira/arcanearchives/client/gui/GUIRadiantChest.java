...
public class GUIRadiantChest extends ContainerScreen implements GuiPageButtonList.GuiResponder, IChestButtonCallback, IItemSearchBar {
  ...
  public GUIRadiantChest(ContainerRadiantChest container, PlayerInventory playerinventory) {
    super(container);
  ...
  public void drawSlot(Slot slotIn) {
    ...
    if (!stack.isEmpty()) {
      if (tracked != null && !tracked.isEmpty() && ManifestTrackingUtils.matches(stack, tracked)) {
        ...
        ContainerScreen.drawRect(slotIn.xPos, slotIn.yPos, slotIn.xPos + 16, slotIn.yPos + 16, c.toInteger());
        GlStateManager.enableDepth();
      }
    }
  ...
  @Override
  public boolean onAddChestButton(Button button, int buttonType) {
    return true;
  }

  @Optional.Method(modid = "quark")
  @Override
  public void onSearchBarAdded(TextFieldWidget bar) {
    bar.y = (height / 2) + 2;
