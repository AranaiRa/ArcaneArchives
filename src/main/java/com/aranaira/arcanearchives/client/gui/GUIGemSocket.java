...
public class GUIGemSocket extends GuiContainer {
	...
	private static final int FABRIAL_X = 102, FABRIAL_Y = 0, FABRIAL_S = 22, STRAP_X = 0, STRAP_Y = 101, STRAP_W = 94, STRAP_H = 37, INVENTORY_W = 181, INVENTORY_H = 101, OFFHAND_X = 207, OFFHAND_Y = 0, OFFHAND_W = 49, OFFHAND_H = 33, OFFHAND_SIMPLE_X = 32, OFFHAND_SIMPLE_Y = 0, OFFHAND_SIMPLE_S = 28, RECHARGE_X = 238, RECHARGE_Y = 33, RECHARGE_S = 18;
