...
//      Vector3d pos = (new Vector3d(x, y, z)).add(getOffset(facing));
...
//    switch (facing) {
//      case NORTH:
//        return new Vector3d(0.5, 0.0, 0.03);
//      case SOUTH:
//        return new Vector3d(0.5, 0.0, 0.97);
//      case EAST:
//        return new Vector3d(0.97, 0.0, 0.5);
//      case WEST:
//        return new Vector3d(0.03, 0.0, 0.5);
//      default:
