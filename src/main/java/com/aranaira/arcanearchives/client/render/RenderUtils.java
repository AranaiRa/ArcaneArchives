...
//
//  @OnlyIn(Dist.CLIENT)
//  public static void drawSegmentedLine(long worldTime, java.awt.Color color, float width, Vector3d player_pos, ArrayList<Vector3d> verts) {
...
//  }
//
//  public static float getLineWidthFromDistance(Vector3d first, Vector3d second, float minDistanceClamp, float maxDistanceClamp) {
...
//    }
//    int colour = Minecraft.getInstance().getBlockColors().colorMultiplier(state, world, pos, 0);
...
//  }
//
//  public static BufferBuilder posVector3d(BufferBuilder bufferBuilder, Vector3d vec3d) {
//    return bufferBuilder.pos(vec3d.x, vec3d.y, vec3d.z);
//  }
//
//  public static void createColoredVertex(BufferBuilder bufferBuilder, Vector3d pos, Color color) {
//    bufferBuilder.pos(pos.x, pos.y, pos.z).color(color.red, color.green, color.blue, color.alpha).endVertex();
//  }
//
//  public static Vector3d getPlayerPosAdjusted(PlayerEntity e, float partialTicks) {
...
//
//    return new Vector3d(iPX, iPY, iPZ);
//  }
//
...
//    switch (face) {
//      case NORTH:
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.minZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.minZ), new Vec2f(maxU, minV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.minZ), new Vec2f(maxU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.minZ), new Vec2f(minU, maxV)));
//        break;
//      case SOUTH:
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.maxZ), new Vec2f(maxU, minV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.maxZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.maxZ), new Vec2f(minU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.maxZ), new Vec2f(maxU, maxV)));
//        break;
//      case EAST:
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.minZ), new Vec2f(maxU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.maxZ), new Vec2f(minU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.maxZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.minZ), new Vec2f(maxU, minV)));
//        break;
//      case WEST:
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.minZ), new Vec2f(maxU, minV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.maxZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.maxZ), new Vec2f(minU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.minZ), new Vec2f(maxU, maxV)));
//        break;
//      case UP:
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.maxZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.maxY, bb.minZ), new Vec2f(minU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.minZ), new Vec2f(maxU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.maxY, bb.maxZ), new Vec2f(maxU, minV)));
//        break;
//      case DOWN:
//      default:
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.minZ), new Vec2f(maxU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.minZ), new Vec2f(minU, maxV)));
//        result.add(new Vertex(new Vector3d(bb.maxX, bb.minY, bb.maxZ), new Vec2f(minU, minV)));
//        result.add(new Vertex(new Vector3d(bb.minX, bb.minY, bb.maxZ), new Vec2f(maxU, minV)));
//        break;
//    }
...
//    private Vec2f uv;
//
//    public Vertex(Vector3d xyz, Vec2f uv) {
//      this.xyz = xyz;
//      this.uv = uv;
//    }
//
