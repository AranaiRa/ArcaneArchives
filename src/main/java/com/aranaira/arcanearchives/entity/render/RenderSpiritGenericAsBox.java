...
public class RenderSpiritGenericAsBox extends RenderLiving<SpiritGeneric>//EntityOBJModel<EntityGeneric>
{
	...
	public RenderSpiritGenericAsBox(RenderManager rendermanagerIn) {
		super(rendermanagerIn, new ModelSpiritGeneric(), 0.5F);
		ArcaneArchives.logger.info("beep boop, running the normal model model");
	}
