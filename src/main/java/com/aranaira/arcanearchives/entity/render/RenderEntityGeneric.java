...
import com.aranaira.arcanearchives.entity.model.ModelEntityGeneric;
...
public class RenderEntityGeneric extends RenderLiving<EntityGeneric>//EntityOBJModel<EntityGeneric>
{
	...
	public RenderEntityGeneric(RenderManager rendermanagerIn) {
		super(rendermanagerIn, new ModelEntityGeneric(), 0.5F);
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityGeneric entity) {
		return TEXTURES;
	}
	
	@Override
	protected void applyRotations(EntityGeneric entity, float p_77043_2_, float yaw, float partialTicks)
	{
