...
public class RenderUtil {
	...
	public static final @Nonnull
	Vector3d ZERO_V = new Vector3d(0, 0, 0);
	...
	public static void getUvForCorner (
			@Nonnull Vector2f uv, @Nonnull Vector3d corner, int x, int y, int z, @Nonnull EnumFacing face, @Nonnull TextureAtlasSprite icon) {
